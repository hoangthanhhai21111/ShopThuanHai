            ...
            <div class="modal-body">
                ...
                <div id="filter-columns">
                    ...
                    <div class="form-group form-row filter-row">
                        ...
                        <div class="col-lg-8">
                            <div class="input text"><input type="text" name="amount" class="form-control filter-column f-name" value="{{ $f_amount }}" id="amount" /></div>
                        </div>
                    </div>
                    <div class="form-group form-row filter-row">
                        <div class="col-lg-4">
                        ...
                        <div class="col-lg-8">
                            <div class="input text"><input type="text" name="price" class="form-control filter-column f-name" value="{{ $f_price }}" id="price" /></div>
                        </div>
                    </div>
